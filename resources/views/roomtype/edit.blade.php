                            ...
                            <table class="table table-bordered  mt-2">
                                <tr>
                                    ...
                                    @foreach($data->roomtypeimgs as $img)
                                        ...
                                        <p class="mt-2">
                                            <button type="button" onclick="return confirm('Do you want to delete this image?')" class="btn btn-danger btn-sm delete-image" data-image-id="{{$img->id}}"> <i class="fa fa-trash"></i>
                                            </button>
                                        </p>
                                        </td>
                                    @endforeach
